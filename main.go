...
const (
	...
	recipientAddress = "testcore1534s8rz2e36lwycr6gkm9vpfe5yf67wkuca7zs" //Only for testing transactions
...
func TryFT() {
	...
	const subunit = "testfn125493474789123"
...
func main() {
	//TryTransaction()
	//TryFT()
	err := side_functions.AssetNFTIssue()
	if err != nil {
